...
import { getIngredients, createIngredient, updateIngredient, deleteIngredient } from "@/app/actions/ingredients";
...
export default function IngredientsPage() {
    ...
    const loadIngredients = async () => {
        try {
            ...
            // Map Drizzle result to local interface if needed, or if Drizzle types match directly
            // Drizzle returns camelCase if defined in schema, but referencing local state mapping
        ...
        >
            <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between">
                    ...
                    {/* Note: assuming simple permission check for buttons visibility locally, 
              but server action is protected by middleware/auth state technically (though we should add explicit checks in actions later) */}
                    {canManage && (
                                    ...
                                    return (
                                        <TableRow key={ingredient.id}>
                                            ...
                                            <TableCell className="text-right font-mono">
                                                {ingredient.currentStock.toLocaleString('id-ID')}
                                            </TableCell>
                                            <TableCell className="text-right font-mono">
                                                {ingredient.minimumStock.toLocaleString('id-ID')}
                                            </TableCell>
                                            <TableCell>
